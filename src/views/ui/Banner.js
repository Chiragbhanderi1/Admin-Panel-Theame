...
const Banner = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://api-23jv80idk-chiragbhanderi1.vercel.app/getbanners")
          .then((res) => res.json())
      ...
      const handleSubmit = async (e) => {
        ...
        fetch("https://api-23jv80idk-chiragbhanderi1.vercel.app/banners", {
          method: "POST",
          headers: {
      ...
      const handleDeleteBanner = (id) => {
        ...
        fetch(`https://api-23jv80idk-chiragbhanderi1.vercel.app/deletebanner/${id}`, {
          method: "DELETE",
        })
          .then((res) => {
      ...
      const handleUpdateBanner = (e) => {
        ...
        fetch(`https://api-23jv80idk-chiragbhanderi1.vercel.app/updatebanner/${bannerData.id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
          },
