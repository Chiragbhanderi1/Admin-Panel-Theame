...
const Internships = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://api-1vjt09w2e-chiragbhanderi1.vercel.app/getinterships")
      .then((res) => res.json())
  ...
  const uploadImg = async()=>{
    ...
    const res = await  fetch("https://api-1vjt09w2e-chiragbhanderi1.vercel.app/fileinteship",{
      method:"POST",
      body:formData
    })
     console.log(res);
  ...
  const handleAddInternship = async (e) => {
    ...
    fetch("https://api-1vjt09w2e-chiragbhanderi1.vercel.app/interships", {
      method: "POST",
      headers: {
  ...
  const handleDeleteInternship = (id) => {
    ...
    fetch(`https://api-1vjt09w2e-chiragbhanderi1.vercel.app/deleteintership/${id}`, {
      method: "DELETE",
    })
      .then(() => {
  ...
  const handleUpdateInternship = (e) => {
   try{ 
     ...
     fetch(`https://api-1vjt09w2e-chiragbhanderi1.vercel.app/updateintership/${internshipData.title}`, {
       method: "PUT",
       headers: {
         "Content-Type": "application/json",
        },
