  ...
  const [achievementData, setAchievementData] = useState({
    ...
    const handleInputChange = (e) => {
      ...
      useEffect(() => {
        ...
        fetch("https://api-f0ms2ifmj-chiragbhanderi1.vercel.app/getachievements")
          .then((res) => res.json())
      ...
      const handleSubmit = async (e) => {
        ...
        fetch("https://api-f0ms2ifmj-chiragbhanderi1.vercel.app/achievements", {
          method: "POST",
          headers: {
      ...
      const handleDeleteAchievement = (id) => {
        ...
        fetch(`https://api-f0ms2ifmj-chiragbhanderi1.vercel.app/deleteachievement/${id}`, {
          method: "DELETE",
        })
          .then(() => {
      ...
      const handleUpdateAchievement = (e) => {
        ...
        fetch(`https://api-f0ms2ifmj-chiragbhanderi1.vercel.app/updateachievement/${achievementData.id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
          },
