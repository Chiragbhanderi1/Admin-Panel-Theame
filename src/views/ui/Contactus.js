...
const Contactus = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://api-cnn5jio2q-chiragbhanderi1.vercel.app/getcontactus")
          .then((res) => res.json())
          .then((data) => {setContacts(data)})
          .catch((err) => console.log(err));
        fetch("https://api-cnn5jio2q-chiragbhanderi1.vercel.app/getnewsletters")
          .then((res) => res.json())
      ...
      const handleDeletecontact = (id) => {
        ...
        fetch(`https://api-cnn5jio2q-chiragbhanderi1.vercel.app/deletecontact/${id}`, {
          method: "DELETE",
        })
          .then(() => {
