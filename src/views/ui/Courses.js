...
const Courses = () => {
  ...
  const uploadImg = async()=>{
   try{ 
    ...
    const res = await  fetch("https://api-p1sakfilu-chiragbhanderi1.vercel.app/filecourses",{
      method:"POST",
      body:formData
    })
     console.log(res);
  ...
  const handleAddCourse = async (e) => {
    ...
    fetch("https://api-p1sakfilu-chiragbhanderi1.vercel.app/courses", {
      method: "POST",
      headers: {
  ...
  const handleDeleteCourse = (id) => {
    ...
    fetch(`https://api-p1sakfilu-chiragbhanderi1.vercel.app/deletecourse/${id}`, {
      method: "DELETE",
    })
      .then(() => {
  ...
  const handleUpdateCourse = (e) => {
   try{ e.preventDefault();
    ...
    fetch(`https://api-p1sakfilu-chiragbhanderi1.vercel.app/updatecourse/${courseData.title}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
