...
const Events = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    fetch("https://api-cnn5jio2q-chiragbhanderi1.vercel.app/events", {
      method: "POST",
      headers: {
  ...
  const handleDeleteEvent = (id) => {
    ...
    fetch(`https://api-cnn5jio2q-chiragbhanderi1.vercel.app/deleteevent/${id}`, {
      method: "DELETE",
    })
      .then(() => {
        setEvents(events.filter((event) => event.title !== id));
      })
      .catch((err) => console.log(err));
  };
  const handleMore =(id)=>{
  ...
  const handleUpdateEvent = (e) => {
    ...
    fetch(`https://api-cnn5jio2q-chiragbhanderi1.vercel.app/updateevent/${eventData.title}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
