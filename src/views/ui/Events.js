...
const Events = () => {
  ...
  const uploadImg = async()=>{
    ...
    const res = await  fetch("https://api-cyu8h01yw-chiragbhanderi1.vercel.app/fileevent",{
      method:"POST",
      body:formData
    })
     console.log(res);
  ...
  const handleSubmit = async (e) => {
    ...
    fetch("https://api-cyu8h01yw-chiragbhanderi1.vercel.app/events", {
      method: "POST",
      headers: {
  ...
  const handleDeleteEvent = (id) => {
    ...
    fetch(`https://api-cyu8h01yw-chiragbhanderi1.vercel.app/deleteevent/${id}`, {
      method: "DELETE",
    })
      .then(() => {
  ...
  const handleUpdateEvent = (e) => {
    ...
    fetch(`https://api-cyu8h01yw-chiragbhanderi1.vercel.app/updateevent/${eventData.title}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
