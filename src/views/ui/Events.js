...
const Events = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://api-1vjt09w2e-chiragbhanderi1.vercel.app/getevents")
      .then((res) => res.json())
  ...
  const uploadImg = async()=>{
    ...
    const res = await  fetch("https://api-1vjt09w2e-chiragbhanderi1.vercel.app/fileevent",{
      method:"POST",
      body:formData
    })
     console.log(res);
  ...
  const handleSubmit = async (e) => {
    ...
    fetch("https://api-1vjt09w2e-chiragbhanderi1.vercel.app/events", {
      method: "POST",
      headers: {
  ...
  const handleDeleteEvent = (id) => {
    ...
    fetch(`https://api-1vjt09w2e-chiragbhanderi1.vercel.app/deleteevent/${id}`, {
      method: "DELETE",
    })
      .then(() => {
  ...
  const handleUpdateEvent = (e) => {
    ...
    fetch(`https://api-1vjt09w2e-chiragbhanderi1.vercel.app/updateevent/${eventData.title}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
