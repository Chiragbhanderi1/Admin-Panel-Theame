...
const Blogs = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://api-l3pjjlrtb-chiragbhanderi1.vercel.app/getblogs")
          .then((res) => res.json())
      ...
      const handleSubmit = async (e) => {
        ...
        fetch("https://api-l3pjjlrtb-chiragbhanderi1.vercel.app/blogs", {
          method: "POST",
          headers: {
      ...
      const handleDeleteBlog = (id) => {
        ...
        fetch(`https://api-l3pjjlrtb-chiragbhanderi1.vercel.app/deleteblog/${id}`, {
          method: "DELETE",
        })
          .then((res) => {
      ...
      const handleUpdateBlog = (e) => {
        ...
        fetch(`https://api-l3pjjlrtb-chiragbhanderi1.vercel.app/updateblog/${blogData.id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
          },
